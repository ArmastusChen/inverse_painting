...
def get_down_block(
    ...
    if down_block_type == "DownBlock2D":
        ...
        if cross_attention_dim is None:
            print('IGNORING CROSS ATTENTION for mask generator')
...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.resnets[0](hidden_states, scale=lora_scale)
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = resnet(hidden_states, scale=lora_scale)
    ...
    def forward(self, hidden_states, temb=None, scale: float = 1.0):
        ...
        for resnet in self.resnets:
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = resnet(hidden_states, scale=scale)
